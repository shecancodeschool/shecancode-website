  ...
  return (
    <>
      <div className="w-full flex flex-col gap-10">
        ...
        <div className="max-w-[86rem] mx-auto flex flex-col justify-center items-center space-y-20 w-full px-4 sm:px-0">
          <div className="flex flex-col justify-evenly items-center h-52">
            <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-7xl text-[#317ACC] text-center font-bold">
              Our services
            </h1>
          </div>
