  ...
  return (
    <>
      <div className="w-full flex flex-col justify-between space-y-20">
        ...
        <div className="w-full">
          <div className="w-full max-w-[80] flex justify-evenly align-middle">
            <HireCards
        ...
        <div className="w-full flex flex-col justify-center items-center h-52">
          <div className="w-full h-full max-w-[83%] flex flex-col gap-10">
        ...
        <div className="w-full max-w-[85%] mx-auto p-4 mb-10">
