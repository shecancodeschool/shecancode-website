...
const StudentsExpectationsBanner = () => {
    return (
        <>
            <div className="relative h-screen md:h-[529px] flex flex-col justify-end overflow-hidden">
                ...
                <div className='absolute inset-0 flex flex-col md:mt-4 mt-10 place-content-center gap-[56px] text-white p-4 md:p-0'>
                    <h3 className="font-semibold text-[50px] max-w-5xl font leading-[70px] md:text-[60px] md:leading-[72px] text-center md:w-[830px] h-[77px] mx-auto font text-[#FFFFFF]">
                    shecancode Learner Expectations
                    </h3>
...
export default StudentsExpectationsBanner