        ...
        <div className="max-w-[84rem] mx-auto mt-[67px] p-4">
            <div className="flex flex-col md:flex-row h-full">
                <div className="flex-1 w-full mb-12 md:pr-8">
                    ...
                    <ol className="list-decimal list-inside ml-4 font text-[20px] md:text-[24px] leading-[31.2px] text-[#000000]/60 text-justify ">
                    ...
                    <ul className="list-disc list-inside ml-4 font text-[20px] md:text-[24px] leading-[31.2px] text-[#000000]/60 text-justify ">
