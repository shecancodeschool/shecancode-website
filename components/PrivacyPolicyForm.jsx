        ...
        <div className="max-w-[84rem] mx-auto mt-[67px] p-4">
            <div className="flex flex-col md:flex-row h-full">
                <div className="flex-1 md:w-[886px] mb-12 md:pr-8">
                    ...
                    <p className="mb-6 font text-[16px] md:text-[24px] leading-[1.4] md:leading-[31.2px] text-[#000000]/68 ">
                    ...
                    <ul className="list-decimal list-inside ml-4 font text-[16px] md:text-[24px] leading-[1.4] md:leading-[31.2px] text-[#000000]/68 ">
                ...
                <div className="w-full md:w-1/3 md:ml-8 mt-8 md:mt-0">
                    ...
                    <ul className="list-inside mb-6 font text-[16px] md:text-[24px] leading-[1.4] md:leading-[31.2px] text-[#000000]/68">
