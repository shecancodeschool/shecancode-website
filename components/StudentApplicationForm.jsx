    ...
    <div className="max-w-3xl mx-auto p-6 rounded-lg">
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block">{labelWithIcon("First name")}</label>
          ...
          <div>
            <label className="block">{labelWithIcon("Last name")}</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block">{labelWithIcon("Email")}</label>
          ...
          <div>
            <label className="block">{labelWithIcon("Phone number")}</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block">{labelWithIcon("Gender")}</label>
          ...
          <div>
            <label className="block">{labelWithIcon("Age")}</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block">{labelWithIcon("School name or institute")}</label>
          ...
          <div className="w-full max-w-md">
            <label className="block">{labelWithIcon("Certificate")}</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div className="w-full max-w-md">
            <label className="block">{labelWithIcon("Resume")}</label>
            <div className="relative flex items-center">
              <input
                type="file"
                id="file"
          ...
          <div className="w-full max-w-md">
            <label className="block">{labelWithIcon("Copy of ID")}</label>
            <div className="relative flex items-center">
              <input
                type="file"
                id="file"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            <label className="block">{labelWithIcon("Github link")}</label>
          ...
          <div>
            <label className="block">{labelWithIcon("Linkedin link")}</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block">{labelWithIcon("Profile link")}</label>
          ...
          <div>
            <label className="block">{labelWithIcon("Current Occupation")}</label>
