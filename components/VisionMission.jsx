    ...
    <div className="max-w-[84rem] mx-auto my-10 md:my-32">
      <div className="mx-auto px-5 md:px-10 lg:px-0 md:gap-[60px] gap-4 grid lg:grid-cols-2">
        ...
        <div className="h-auto md:mr-8 mt-8 md:mt-0">
          <h2 className=" text-[40px] text-center md:text-3xl md:mb-20 mb-3 lg:text-[50px] font-semibold text-[#317ACC]">Our Vision</h2>
          <p className="text-[#000000] text-opacity-40 text-lg md:text-xl lg:text-[28px] leading-6 md:leading-10 mt-10 text-justify">
        ...
        <div className="h-auto mt-8 md:mt-0">
          <h2 className="text-[40px] text-center md:text-3xl md:mb-20 mb-3 lg:text-[50px] font-semibold text-[#317ACC]">Our Mission</h2>
          <p className="text-[#000000] text-opacity-40 text-lg md:text-xl lg:text-[28px] leading-6 md:leading-10 mt-10 text-justify">
