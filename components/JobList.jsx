            ...
            <main className="flex-1 p-4 md:p-6 lg:p-8">
                ...
                <div className="flex flex-col md:flex-row md:space-x-4 mb-6">
                    ...
                    <div className="bg-[#FFFFFF] shadow p-4 rounded-lg  w-[276.63px] md:w-1/3 ">
                        <p className="text-[#8F9BB3] text-[13px] leading-[16px] font">Published</p>
                            ...
                            <tbody>
                                <tr className="bg-white border-b">
                                    <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        <div className="font-semibold text-[#222B45] text-[13px] leading-[16px] font">Front-end Trainer</div>
                                        <p className="text-[#8F9BB3] text-[12px] font">Kacyiru 2/3/2024</p>
                                    </td>
                                    <td className="bg-[#DFC186] text-[13px] font-bold rounded-lg text-center text-[#FFFFFF]">Published</td>
                                ...
                                <tr className="bg-white border-b">
                                    <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        <div className="font-semibold text-[#222B45] text-[13px] leading-[16px] font">Mobile Developer</div>
                                        <p className="text-[#8F9BB3] text-[12px] font">Kacyiru 2/3/2024</p>
                                    </td>
                                    <td className="bg-[#848383] text-[13px]  rounded-lg text-center text-[#FFFFFF]">Not Yet Published</td>
                                    <td className=" px-6 py-4 text-[#222B45] text-[12px] font">24 Oct, 2015</td>
                                    <td className="px-6 py-4 text-[#222B45] text-[12px] font">Full-time</td>
                                ...
                                <tr className="bg-white border-b">
                                    <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        <div className="font-semibold text-[#222B45] text-[13px] leading-[16px] font">QA Engineer</div>
                                        <p className="text-[#8F9BB3] text-[12px] font">Kacyiru 2/3/2024</p>
                                    </td>
                                    <td className="bg-[#848383] text-[13px]  rounded-lg text-center text-[#FFFFFF]">Not Yet published</td>
                                    <td className="px-6 py-4 text-[#222B45] text-[12px] font">24 Oct, 2015</td>
                                ...
                                <tr className="bg-white border-b">
                                    <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        <div className="font-semibold text-[#222B45] text-[13px] leading-[16px] font">Software Engineer</div>
                                        <p className="text-[#8F9BB3] text-[12px] font">Kacyiru 2/3/2024</p>
                                    </td>
                                    <td className="bg-[#848383] text-[13px]  rounded-lg text-center text-[#FFFFFF]">Not Yet published</td>
                                    <td className="px-6 py-4 text-[#222B45] text-[12px] font">24 Oct, 2015</td>
