        ...
        <>
            <div className="relative  isolate flex flex-col justify-end overflow-hidden">
                ...
                <div className='absolute inset-0 flex flex-col md:mt-4 mt-10 justify-center items-center place-content-center gap-[56px] text-white p-4 md:p-0'>
                    <h3 className="font-bold text-[40px] leading-[48px] md:text-[60px] md:leading-[72px] text-center w-[830px] h-[77px] mx-auto font text-[#FFFFFF]">
                        Get To know more <span className="font-normal text-[40px] leading-[48px] md:text-[60px] md:leading-[72px] ">About</span> us
                    </h3>
