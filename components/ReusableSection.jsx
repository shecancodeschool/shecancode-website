const ReusableSection = (props) => {
    ...
    return (
        <div style={{ flexDirection: flexDirection }} className={`bg-${background} flex flex-col items-center justify-center mx-auto w-full px-4 md:px-12 py-16 md:pb-32 overflow-hidden`}>
