...
const Statistics = () => {
  ...
  return (
    <div className='px-4 md:px-2 w-full py-16 md:pb-24 max-w-screen-xl mx-auto flex items-center flex-col justify-center place-content-center'>
      ...
      <div className='flex flex-wrap justify-evenly w-full mt-3 items-baseline place-content-center'>
        {statistics && statistics.map((statistics, index) => (
          <div key={index} className='flex flex-col justify-center items-center md:gap-4 mb-8 md:mb-0 bg-white md:rounded-lg md:shadow-none mt-4 w-full sm:w-8 md:w-fit flex-shrink'>
